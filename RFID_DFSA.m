...
iteration=1000;  %평균치를 구하기 위한 반복 횟수
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        while tag_n>0
            current_tag_n=floor(log(middle_idle_P)/(log(1-1/L)));
...
hold on; grid on;
x=100:100:1000;
plot(x, (sum_DFSA_P_idle/iter) ); %확률 평균치 그래프로 나타내기
plot(x, (sum_DFSA_P_coll/iter) );
plot(x, (sum_DFSA_P_succ/iter) );
